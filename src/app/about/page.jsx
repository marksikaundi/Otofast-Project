...
export default function page() {
  return (
    <div className="max-w-6xl mx-auto space-y-4 p-4">
      ...
      <h5 className="text-sm">Last updates 07/02/2023 by Mark Sikaundi</h5>
      ...
      <p className="text-white">
        ...
        and broaden your horizons. From meetups and hackathons to online forums
        and social media groups, Otofast offers a range of opportunities for
