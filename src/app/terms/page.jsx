  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4 p-4">
      ...
      <p className="text-white">
        Welcome to <strong>Otofast Project</strong>! These terms and conditions
        outline the rules and regulations for the use of Otofast Project's
        Website, located at https://otofastproject.com. By accessing this
        website we assume you accept these terms and conditions. Do not continue
        to use Otofast Project if you do not agree to take all of the terms and
        ...
        on this website and compliant to the Companys terms and conditions. "The
        ...
        Clients needs in respect of provision of the Companys stated services,
        ...
        accessing Otofast Project, you agreed to use cookies in agreement with
        the Otofast Project's Privacy Policy. Most interactive websites use
        cookies to let us retrieve the users details for each visit. Cookies are
        ...
        otherwise stated, Otofast Project and/or its licensors own the
        intellectual property rights for all material on Otofast Project. All
        intellectual property rights are reserved. You may access this from
        Otofast Project for your own personal use subjected to restrictions set
        in these terms and conditions. You must not: Republish material from
        Otofast Project Sell, rent or sub-license material from Otofast Project
        Reproduce, duplicate or copy material from Otofast Project Redistribute
        content from Otofast Project This Agreement shall begin on the date
        hereof. Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Otofast Project does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Otofast Project,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Otofast Project
        ...
        of and/or appearance of the Comments on this website. Otofast Project
        ...
        unlawful activity. You hereby grant Otofast Project a non-exclusive
        ...
        fits within the context of the linking partys site. We may consider and
        ...
        the hyperlink compensates the absence of Otofast Project; and (d) the
        ...
        services; and (c) fits within the context of the linking partys site. If
        you are one of the organizations listed in paragraph 2 above and are
        interested in linking to our website, you must inform us by sending an
        e-mail to Otofast Project. Please include your name, your organization
        ...
        locator being linked to; or By use of any other description of our Web 2
        ...
        description of our Web site being linked to that makes sense within the
        context and format of content on the linking partys site. No use of
        Otofast Project's logo or other artwork will be allowed for linking
      ...
      <p className="text-white">
        ...
        linked to; or By use of any other description of our Web site being
        linked to that makes sense within the context and format of content on
        the linking partys site. No use of Otofast Project's logo or other
        ...
        information on this website is complete, true, or 3 weeks for a
        response. Approved organizations may hyperlink to our Web 2 weeks for a
        response. Approved organizations may hyperlink to our Website as
        follows: By use of our corporate name; or By use of the uniform resource
        locator being linked to; or By use of any other description of our Web
        site being linked to that makes sense within the context and format of
        content on the linking partys site. No use of Otofast Project's logo or
        ...
        Approved organizations may hyperlink to our Web 2 weeks for a response.
        Approved organizations may hyperlink to our Website as follows: By use
        of our corporate name; or By use of the uniform resource locator being
        linked to; or By use of any other description of our Web site being
        linked to that makes sense within the context and format of content on
